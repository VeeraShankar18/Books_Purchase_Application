...
import com.project2.www.Service.MythologyBooksService;
import com.project2.www.Store.MythologyBooks;

@RestController
@RequestMapping("/MythologyBooks")
@CrossOrigin(origins="*")
public class MythologyBooksController 
{
	@Autowired
	MythologyBooksService booksService;
	...
	@PostMapping("/add")
	public String addBookDetails(@RequestBody MythologyBooks mythologyBooks)
	{
		return booksService.addBookDetails(mythologyBooks);
	}
	
	@PutMapping("/update/{bookNum}")
	public String updateBookDetails(@PathVariable long bookNum,@RequestBody MythologyBooks bookDetails)
	{
